...
class FatturaPAAttachmentIn(models.Model):
    ...
    #         error_msg = _(
    #             "Impossible to parse XML for {att_name}: {error_msg}"
    #         ).format(
    ...
    #         invoices_date = []
    #         for invoice_body in fatt.FatturaElettronicaBody:
    #             amount_untaxed = invoice_model.compute_xml_amount_untaxed(
    #                 invoice_body
    #             )
    ...
    #             if fatt:
    #                 for invoice_body in fatt.FatturaElettronicaBody:
    #                     inv_linked = invoice_body.DatiGenerali.DatiFattureCollegate
    #                     if inv_linked and len(inv_linked) == 1:
    #                         att.linked_invoice_id_xml = (
    #                             inv_linked[0].IdDocumento
    #                         )

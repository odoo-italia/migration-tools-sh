...
class EFatturaOut:
    ...
    #
    #             try:
    #                 narrations = html.fromstring(invoice.narration).xpath("//text()")
    #                 narration_text = "\n".join(
    #                     text.strip() for text in narrations
    #                 )
    #             except Exception:
    #                 narration_text = ""
    #             # >8 end meanwhile
    ...
    #             else "".join(
    #                 [
    #                     file_name[: (60 - len(file_extension))],
    #                     file_extension
    #                 ]
    #             )
    #         )
    ...
    #         if attachment_type:
    #             return encode_for_export(attachment_type, 10)
    #         return False
    #
    #     def in_eu(partner):

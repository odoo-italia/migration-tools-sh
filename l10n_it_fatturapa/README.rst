...
.. |badge3| image:: https://img.shields.io/badge/github-odoo--italia%2Fmigration--tools--sh-lightgray.png?logo=github
    :target: https://github.com/odoo-italia/migration-tools-sh/tree/18.0/l10n_it_fatturapa
...
`feedback <https://github.com/odoo-italia/migration-tools-sh/issues/new?body=module:%20l10n_it_fatturapa%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `odoo-italia/migration-tools-sh <https://github.com/odoo-italia/migration-tools-sh/tree/18.0/l10n_it_fatturapa>`_ project on GitHub.

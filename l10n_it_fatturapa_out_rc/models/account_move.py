...
class AccountMove(models.Model):
    ...
    #         raise UserError(
    #             _(
    #                 "Selected reverse charge invoices have different suppliers.
    #                 " Please select invoices with same supplier"
    #             )
    #         )
    #     if len(rc_suppliers) < 1:
    #         raise UserError(
    #             _("Please specify a supplier in reverse charge invoices.")
    #         )
    #
